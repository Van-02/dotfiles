...
class Stack:
    ...
    def pop(self):
        container = input("What container wish delete -> ")
        aux_stack = []

        while self.items[-1] != container:
            aux_stack.append(self.items.pop())
...
"""
7. Dado un archivo de texto con algunas lineas de texto dentro, 
cualesquiera, realizar un programa que genere un archivo de texto llamado 
invertido.txt que contenga las lineas en orden inverso al archivo de texto 
original.
"""
aux_stack = []
...
with open('text.txt', 'r') as file:
    ...
    for i in lines.copy():
        aux_stack.append(lines.pop())

with open('invertido.txt', 'w') as file:
    while aux_stack:
        file.write(aux_stack.pop())

"""
8. (*)Implementar un Verificador de codigo HTML para chequear que un 
archivo HTML sea valido.
Infor: En un documento HTML, el contenido se organiza en etiquetas HTML. 
Las etiquetas que abren tienen la forma < etiqueta > y las correspondientes 
etiquetas que cierran tienen la forma < /etiqueta >
...
Luego, su verificador debera pedir un archivo de texto con extension 
correspondiente .htm o .html y verificar su codigo HTML este correcto. 
Ejemplo de un archivo .html a continuacion, puede probar abrirlo con un 
explorador web para verlo bien.
...
"""
9. Implementar una calculadora de Notacion Polaca Inversa. Recuerde que la 
forma en que usualmente escribimos las expresiones aritmeticas, es usando 
la notacion de infijo.
"""

"""
10. Implementar una funcion que invierta el orden de las palabras de una 
frase. Ejemplo: Si recibe la frase 'Buen dia!' retornara 'dia! Buen'
"""
