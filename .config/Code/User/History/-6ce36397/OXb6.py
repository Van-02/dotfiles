...
class ListaEnlazada:
    ...
    def mostrar_nombre(self):
        ...
        while aux_nodo != None:
            print(aux_nodo.dato.imprimir_nombre(), end=' -> ')
...
while opcion != 's':
    ...
    if opcion == '1':
        print(lista.mostrar_nombre())
        pass

    elif opcion == '2':
        archivo = open('./agenda.txt', "a")
        # Guarda la lista enlazada que tiene la direccion de todos los amigos
        archivo.write(f"{lista.raiz}")
        archivo.close()
