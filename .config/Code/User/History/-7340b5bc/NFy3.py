    ...
    try:
        with open(f"31/{input_filename}.txt", "r", encoding="utf-8") as fr, \
            ...
            for line in fr:
                ...
                lenght = len(clean_line)
                fw.write(f"{lenght};{clean_line}\n")

        print(f"Success! '{output_filename}.txt' has been generated.")
    except FileNotFoundError:
        print(f"Error: The file {input_filename}.txt does not exist.")


process_line_lengths("test", "line_counts")
